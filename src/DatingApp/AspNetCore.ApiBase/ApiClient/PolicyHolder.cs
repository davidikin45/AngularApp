...
namespace AspNetCore.ApiBase.ApiClient
{
    ...
    {
        public static PolicyWrap<HttpResponseMessage> GetRequestPolicy(IMemoryCache memoryCache = null, int cacheSeconds = 0, int additionalRetries = 0, int requestTimeoutSeconds = 100)
        {
            ...
            PolicyWrap<HttpResponseMessage> policyWrap = null;
            if (cache != null)
            {
