...
namespace AspNetCore.ApiBase.Middleware.ImageProcessing
{
    public class ContentHandlerMiddleware
    {
        ...
        public ContentHandlerMiddleware(RequestDelegate next, IHostingEnvironment hostingEnvironment, IList<string> validFolders, AppSettings appSettings, int cacheDays)
        {
        ...
        {
            await new ContentHttpHandler(_hostingEnvironment, _validFolders, AppSettings, CacheDays).ProcessRequestAsync(context);
    ...
    public class ContentHttpHandler : BaseRangeRequestHandler
    {
        ...
        public ContentHttpHandler(IHostingEnvironment hostingEnvironment, IList<string> validFolders, AppSettings appSettings, int cacheDays)
        {
            _hostingEnvironment = hostingEnvironment;
            _validFolders = validFolders;
            AppSettings = appSettings;
        ...
        public async override Task CreateResponseContentIfRequiredAsync(HttpContext context)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        var converter = new VideoConverter(_hostingEnvironment.MapContentPath(AppSettings.FFMpeg));
